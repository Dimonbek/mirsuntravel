...
const defaultLocales = {
  uz: {
    ...
    chooseService: "🧾 Sizga qanday xizmat kerak?",
    svcTravel: "✈️ Sayohat",
    svcAir: "🎫 Aviakassa",
    svcRail: "🚂 Temir yo'l kassa",
    askRoute: "🗺 Siz qachon va qayerga bormoqchisiz?\n_Masalan: Toshkent → Moskva, 18-avgust_",
    invalidRoute: "❌ Iltimos, yo'nalish va sanani yozing.\n_Masalan: Toshkent → Moskva, 18-avgust_",
    ...
    askInstallment: "📆 Nasiya turini tanlang:",
    instAnor: "🍎 Anor nasiya",
    instUzum: "🍇 Uzum nasiya",
    instZoodpay: "💠 Zoodpay nasiya",
    instPaylater: "🕒 Paylater nasiya",
    ...
    g_name: "👤 Ismi",
    g_service: "🧾 Xizmat turi",
    g_route: "🗺 Yo'nalish va sana",
  ...
  ru: {
    ...
    svcTravel: "✈️ Путешествие",
    svcAir: "🎫 Авиакасса",
    svcRail: "🚂 Ж/д касса",
    askRoute: "🗺 Когда и куда вы хотите поехать?\n_Например: Ташкент → Москва, 18 августа_",
    invalidRoute: "❌ Пожалуйста, укажите направление и дату.\n_Например: Ташкент → Москва, 18 августа_",
    ...
    askInstallment: "📆 Выберите вид рассрочки:",
    instAnor: "🍎 Anor рассрочка",
    instUzum: "🍇 Uzum рассрочка",
    instZoodpay: "💠 Zoodpay рассрочка",
    instPaylater: "🕒 Paylater рассрочка",
